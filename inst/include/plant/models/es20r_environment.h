// -*-c++-*-
#ifndef PLANT_PLANT_ES20r_ENVIRONMENT_H_
#define PLANT_PLANT_ES20r_ENVIRONMENT_H_
...
class ES20r_Environment : public Environment {
public:
  ...
  ES20r_Environment(double disturbance_mean_interval,
...
inline Rcpp::NumericMatrix get_state(const ES20r_Environment environment) {
  using namespace Rcpp;
