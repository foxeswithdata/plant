// -*-c++-*-
#ifndef PLANT_PLANT_ES20r_STRATEGY_H_
#define PLANT_PLANT_ES20r_STRATEGY_H_
...
class ES20r_Strategy: public Strategy<ES20r_Environment> {
public:
  typedef std::shared_ptr<ES20r_Strategy> ptr;
  ES20r_Strategy();
  ...
  double dbiomass_dt(const ES20r_Environment& environment, double mass_storage) const;
  
  double dmass_storage_dt(double net_mass_production_dt_, double dbiomass_dt_ ) const;
  
  
  void compute_rates(const ES20r_Environment& environment, bool reuse_intervals,
                     Internals& vars);
  ...
  double net_mass_production_dt(const ES20r_Environment& environment,
  ...
  double establishment_probability(const ES20r_Environment& environment);
  ...
  Assimilation<ES20r_Environment> assimilator;
  
  virtual ~ES20r_Strategy() {}
