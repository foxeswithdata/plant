...
template <> SEXP wrap(const plant::ode::Runner<plant::tools::IndividualRunner<plant::ES20_Strategy, plant::ES20_Environment> >&);
template <> plant::ode::Runner<plant::tools::IndividualRunner<plant::ES20_Strategy, plant::ES20_Environment> > as(SEXP);
...
template <> SEXP wrap(const plant::Individual<plant::ES20_Strategy,plant::ES20_Environment>&);
template <> plant::Individual<plant::ES20_Strategy,plant::ES20_Environment> as(SEXP);
...
template <> SEXP wrap(const plant::tools::IndividualRunner<plant::ES20_Strategy,plant::ES20_Environment>&);
template <> plant::tools::IndividualRunner<plant::ES20_Strategy,plant::ES20_Environment> as(SEXP);
