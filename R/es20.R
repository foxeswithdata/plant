# Built from  R/ff16.R on Sat Jul  4 11:14:02 2020 using the scaffolder, from the strategy:  FF16
...
##' @export
##' @rdname ES20
##' @param p A \code{Parameters<ES20>} object
...
ES20_StochasticSpecies <- function(s=ES20_Strategy()) {
  StochasticSpecies("ES20")(s)
}

##' @export
##' @rdname ES20
ES20_StochasticPatch <- function(p) {
  StochasticPatch("ES20")(p)
}

##' @export
##' @rdname ES20
ES20_StochasticPatchRunner <- function(p) {
  StochasticPatchRunner("ES20")(p)
}
