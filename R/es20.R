# Built from  R/ff16.R on Wed Sep 16 07:11:11 2020 using the scaffolder, from the strategy:  FF16
...
##' pl <- ES20_Individual()
##' pl$height
ES20_Individual <- function(s=ES20_Strategy()) {
  Individual("ES20", "ES20_Env")(s)
}
...
##'
##' @export
ES20_fixed_environment <- function(e=1.0, p = ES20_Parameters(), height_max = 150.0) {
  env <- ES20_make_environment(p)
