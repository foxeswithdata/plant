...
##' Create a ES20r Plant or Cohort
##' @title Create a ES20r Plant or Cohort
##' @param s A \code{\link{ES20r_Strategy}} object
##' @export
##' @rdname ES20r
##' @examples
##' pl <- ES20r_Plant()
##' pl$height
ES20r_Plant <- function(s=ES20r_Strategy()) {
  Plant("ES20r", "ES20r_Env")(s)
}

#' Compute the whole plant light compensation point for a single
#' plant with ES20r strategy. Called via general function in plant.R
##' @export
##' @rdname ES20r
`lcp_whole_plant.Plant<ES20r>` <- function(p, ...) {
  ES20r_lcp_whole_plant(p, ...)
}

##' @export
##' @rdname ES20r
ES20r_Cohort <- function(s=ES20r_Strategy()) {
  Cohort("ES20r", "ES20r_Env")(s)
}

##' @export
##' @rdname ES20r
ES20r_Species <- function(s=ES20r_Strategy()) {
  Species("ES20r", "ES20r_Env")(s)
}

##' @export
##' @rdname ES20r
##' @param ... Arguments!
ES20r_Parameters <- function() {
  Parameters("ES20r","ES20r_Env")(hyperpar=ES20r_hyperpar)
}

##' @export
##' @rdname ES20r
##' @param p A \code{Parameters<ES20r,ES20r_Env>} object
ES20r_Patch <- function(p) {
  Patch("ES20r", "ES20r_Env")(p)
}

##' @export
##' @rdname ES20r
ES20r_SCM <- function(p) {
  SCM("ES20r", "ES20r_Env")(p)
}

##' @export
##' @rdname ES20r
ES20r_StochasticSpecies <- function(s=ES20r_Strategy()) {
  StochasticSpecies("ES20r", "ES20r_Env")(s)
}

##' @export
##' @rdname ES20r
ES20r_StochasticPatch <- function(p) {
  StochasticPatch("ES20r", "ES20r_Env")(p)
}

##' @export
##' @rdname ES20r
ES20r_StochasticPatchRunner <- function(p) {
  StochasticPatchRunner("ES20r", "ES20r_Env")(p)
}

# ##' @export
# ##' @rdname ES20r
# ES20r_PlantPlus <- function(s=ES20r_Strategy()) {
#   PlantPlus("ES20r")(s)
# }

## Helper:
##' @export
##' @rdname ES20r_Environment
##' @param p A Parameters object
ES20r_make_environment <- function(p) {
  ES20r_Environment(p$disturbance_mean_interval, p$seed_rain, p$k_I, p$control)
}

##' Hyperparameters for ES20r physiological model
##' @title Hyperparameters for ES20r physiological model
...
##' @export
##' @rdname ES20r_hyperpar
make_ES20r_hyperpar <- function(
                                lma_0=0.1978791,
                                B_kl1=0.4565855,
                                B_kl2=1.71,
                                rho_0=608.0,
...
##' Hyperparameter function for ES20r physiological model
##' @title Hyperparameter function for ES20r physiological model
...
##' @export
ES20r_hyperpar <- make_ES20r_hyperpar()
