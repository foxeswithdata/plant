...
## Version: 0.2.4
## Hash: ffbafc362ab9f13f48168d5c33ec0770
...
Plant <- function(T) {
  type <- c(T)
  valid <- list("Plant<FF16>"="FF16", "Plant<FF16r>"="FF16r", "Plant<ES20>"="ES20")
  constructors <- list("Plant<FF16>"=`Plant<FF16>`, "Plant<FF16r>"=`Plant<FF16r>`, "Plant<ES20>"=`Plant<ES20>`)
  constructors[[check_type(type, valid)]]
}
...
`Plant<ES20>` <- function(s) {
  Plant___ES20__ctor(s)
}
.R6_Plant___ES20 <-
  R6::R6Class(
    "Plant<ES20>",
    ...
    public=list(
      ...
      area_leaf_above = function(h) {
        Plant___ES20__area_leaf_above(self, h)
      },
      compute_vars_phys = function(environment) {
        Plant___ES20__compute_vars_phys(self, environment)
      },
      germination_probability = function(environment) {
        Plant___ES20__germination_probability(self, environment)
      },
      reset_mortality = function() {
        Plant___ES20__reset_mortality(self)
      }),
    active=list(
      height = function(value) {
        if (missing(value)) {
          Plant___ES20__height__get(self)
        } else {
          Plant___ES20__height__set(self, value)
        }
      },
      mortality = function(value) {
        if (missing(value)) {
          Plant___ES20__mortality__get(self)
        } else {
          Plant___ES20__mortality__set(self, value)
        }
      },
      fecundity = function(value) {
        if (missing(value)) {
          Plant___ES20__fecundity__get(self)
        } else {
          Plant___ES20__fecundity__set(self, value)
        }
      },
      strategy = function(value) {
        if (missing(value)) {
          Plant___ES20__strategy__get(self)
        } else {
          stop("Plant<ES20>$strategy is read-only")
        }
      },
      internals = function(value) {
        if (missing(value)) {
          Plant___ES20__internals__get(self)
        } else {
          stop("Plant<ES20>$internals is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
          Plant___ES20__ode_size__get(self)
        } else {
          stop("Plant<ES20>$ode_size is read-only")
        }
      },
      ode_state = function(value) {
        if (missing(value)) {
          Plant___ES20__ode_state__get(self)
        } else {
          Plant___ES20__ode_state__set(self, value)
        }
      },
      ode_rates = function(value) {
        if (missing(value)) {
          Plant___ES20__ode_rates__get(self)
        } else {
          stop("Plant<ES20>$ode_rates is read-only")
        }
      },
      ode_names = function(value) {
        if (missing(value)) {
          Plant___ES20__ode_names__get(self)
        } else {
          stop("Plant<ES20>$ode_names is read-only")
        }
      },
      mortality_probability = function(value) {
        if (missing(value)) {
          Plant___ES20__mortality_probability__get(self)
        } else {
          stop("Plant<ES20>$mortality_probability is read-only")
        }
      },
      strategy_name = function(value) {
        if (missing(value)) {
          Plant___ES20__strategy_name__get(self)
        } else {
          stop("Plant<ES20>$strategy_name is read-only")
        }
      }))

PlantRunner <- function(T) {
  type <- c(T)
  valid <- list("PlantRunner<FF16>"="FF16", "PlantRunner<FF16r>"="FF16r", "PlantRunner<ES20>"="ES20")
  constructors <- list("PlantRunner<FF16>"=`PlantRunner<FF16>`, "PlantRunner<FF16r>"=`PlantRunner<FF16r>`, "PlantRunner<ES20>"=`PlantRunner<ES20>`)
  constructors[[check_type(type, valid)]]
}
...
`PlantRunner<ES20>` <- function(plant, environment) {
  PlantRunner___ES20__ctor(plant, environment)
}
.R6_PlantRunner___ES20 <-
  R6::R6Class(
    "PlantRunner<ES20>",
    inherit=.R6_PlantRunner,
    portable=TRUE,
    ...
    active=list(
      plant = function(value) {
        if (missing(value)) {
          PlantRunner___ES20__plant__get(self)
        } else {
          PlantRunner___ES20__plant__set(self, value)
        }
      }))
...
Parameters <- function(T) {
  type <- c(T)
  valid <- list("Parameters<FF16>"="FF16", "Parameters<FF16r>"="FF16r", "Parameters<ES20>"="ES20")
  constructors <- list("Parameters<FF16>"=`Parameters<FF16>`, "Parameters<FF16r>"=`Parameters<FF16r>`, "Parameters<ES20>"=`Parameters<ES20>`)
  constructors[[check_type(type, valid)]]
}
...
`Parameters<ES20>` <- function(..., values=list(...)) {
  ret <- Parameters___ES20__ctor()
  if (length(values) > 0L) {
    if (is.null(names(values)) || any(names(values) == "")) {
      stop("All values must be named")
    }
...
PlantPlus <- function(T) {
  type <- c(T)
  valid <- list("PlantPlus<FF16>"="FF16", "PlantPlus<FF16r>"="FF16r", "PlantPlus<ES20>"="ES20")
  constructors <- list("PlantPlus<FF16>"=`PlantPlus<FF16>`, "PlantPlus<FF16r>"=`PlantPlus<FF16r>`, "PlantPlus<ES20>"=`PlantPlus<ES20>`)
  constructors[[check_type(type, valid)]]
}
...
`PlantPlus<ES20>` <- function(strategy) {
  PlantPlus___ES20__ctor(strategy)
}
.R6_PlantPlus___ES20 <-
  R6::R6Class(
    "PlantPlus<ES20>",
    ...
    public=list(
      ...
      area_leaf_above = function(h) {
        PlantPlus___ES20__area_leaf_above(self, h)
      },
      compute_vars_phys = function(environment) {
        PlantPlus___ES20__compute_vars_phys(self, environment)
      },
      compute_vars_growth = function() {
        PlantPlus___ES20__compute_vars_growth(self)
      },
      germination_probability = function(environment) {
        PlantPlus___ES20__germination_probability(self, environment)
      },
      to_plant = function() {
        PlantPlus___ES20__to_plant(self)
      }),
    active=list(
      height = function(value) {
        if (missing(value)) {
          PlantPlus___ES20__height__get(self)
        } else {
          PlantPlus___ES20__height__set(self, value)
        }
      },
      mortality = function(value) {
        if (missing(value)) {
          PlantPlus___ES20__mortality__get(self)
        } else {
          PlantPlus___ES20__mortality__set(self, value)
        }
      },
      fecundity = function(value) {
        if (missing(value)) {
          PlantPlus___ES20__fecundity__get(self)
        } else {
          PlantPlus___ES20__fecundity__set(self, value)
        }
      },
      area_heartwood = function(value) {
        if (missing(value)) {
          PlantPlus___ES20__area_heartwood__get(self)
        } else {
          PlantPlus___ES20__area_heartwood__set(self, value)
        }
      },
      mass_heartwood = function(value) {
        if (missing(value)) {
          PlantPlus___ES20__mass_heartwood__get(self)
        } else {
          PlantPlus___ES20__mass_heartwood__set(self, value)
        }
      },
      area_leaf = function(value) {
        if (missing(value)) {
          PlantPlus___ES20__area_leaf__get(self)
        } else {
          stop("PlantPlus<ES20>$area_leaf is read-only")
        }
      },
      strategy = function(value) {
        if (missing(value)) {
          PlantPlus___ES20__strategy__get(self)
        } else {
          stop("PlantPlus<ES20>$strategy is read-only")
        }
      },
      internals = function(value) {
        if (missing(value)) {
          PlantPlus___ES20__internals__get(self)
        } else {
          stop("PlantPlus<ES20>$internals is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
          PlantPlus___ES20__ode_size__get(self)
        } else {
          stop("PlantPlus<ES20>$ode_size is read-only")
        }
      },
      ode_state = function(value) {
        if (missing(value)) {
          PlantPlus___ES20__ode_state__get(self)
        } else {
          PlantPlus___ES20__ode_state__set(self, value)
        }
      },
      ode_rates = function(value) {
        if (missing(value)) {
          PlantPlus___ES20__ode_rates__get(self)
        } else {
          stop("PlantPlus<ES20>$ode_rates is read-only")
        }
      },
      ode_names = function(value) {
        if (missing(value)) {
          PlantPlus___ES20__ode_names__get(self)
        } else {
          stop("PlantPlus<ES20>$ode_names is read-only")
        }
      },
      strategy_name = function(value) {
        if (missing(value)) {
          PlantPlus___ES20__strategy_name__get(self)
        } else {
          stop("PlantPlus<ES20>$strategy_name is read-only")
        }
      }))
...
Cohort <- function(T) {
  type <- c(T)
  valid <- list("Cohort<FF16>"="FF16", "Cohort<FF16r>"="FF16r", "Cohort<ES20>"="ES20")
  constructors <- list("Cohort<FF16>"=`Cohort<FF16>`, "Cohort<FF16r>"=`Cohort<FF16r>`, "Cohort<ES20>"=`Cohort<ES20>`)
  constructors[[check_type(type, valid)]]
}
...
`Cohort<ES20>` <- function(strategy) {
  Cohort___ES20__ctor(strategy)
}
.R6_Cohort___ES20 <-
  R6::R6Class(
    "Cohort<ES20>",
    ...
    public=list(
      ...
      area_leaf_above = function(height) {
        Cohort___ES20__area_leaf_above(self, height)
      },
      growth_rate_gradient = function(environment) {
        Cohort___ES20__growth_rate_gradient(self, environment)
      },
      compute_vars_phys = function(environment) {
        Cohort___ES20__compute_vars_phys(self, environment)
      },
      compute_initial_conditions = function(environment) {
        Cohort___ES20__compute_initial_conditions(self, environment)
      }),
    active=list(
      plant = function(value) {
        if (missing(value)) {
          Cohort___ES20__plant__get(self)
        } else {
          stop("Cohort<ES20>$plant is read-only")
        }
      },
      height = function(value) {
        if (missing(value)) {
          Cohort___ES20__height__get(self)
        } else {
          stop("Cohort<ES20>$height is read-only")
        }
      },
      log_density = function(value) {
        if (missing(value)) {
          Cohort___ES20__log_density__get(self)
        } else {
          stop("Cohort<ES20>$log_density is read-only")
        }
      },
      area_leaf = function(value) {
        if (missing(value)) {
          Cohort___ES20__area_leaf__get(self)
        } else {
          stop("Cohort<ES20>$area_leaf is read-only")
        }
      },
      fecundity = function(value) {
        if (missing(value)) {
          Cohort___ES20__fecundity__get(self)
        } else {
          stop("Cohort<ES20>$fecundity is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
          Cohort___ES20__ode_size__get(self)
        } else {
          stop("Cohort<ES20>$ode_size is read-only")
        }
      },
      ode_state = function(value) {
        if (missing(value)) {
          Cohort___ES20__ode_state__get(self)
        } else {
          Cohort___ES20__ode_state__set(self, value)
        }
      },
      ode_rates = function(value) {
        if (missing(value)) {
          Cohort___ES20__ode_rates__get(self)
        } else {
          stop("Cohort<ES20>$ode_rates is read-only")
        }
      },
      ode_names = function(value) {
        if (missing(value)) {
          Cohort___ES20__ode_names__get(self)
        } else {
          stop("Cohort<ES20>$ode_names is read-only")
        }
      }))

Species <- function(T) {
  type <- c(T)
  valid <- list("Species<FF16>"="FF16", "Species<FF16r>"="FF16r", "Species<ES20>"="ES20")
  constructors <- list("Species<FF16>"=`Species<FF16>`, "Species<FF16r>"=`Species<FF16r>`, "Species<ES20>"=`Species<ES20>`)
  constructors[[check_type(type, valid)]]
}
...
`Species<ES20>` <- function(strategy) {
  Species___ES20__ctor(strategy)
}
.R6_Species___ES20 <-
  R6::R6Class(
    "Species<ES20>",
    ...
    public=list(
      ...
      clear = function() {
        Species___ES20__clear(self)
      },
      compute_vars_phys = function(environment) {
        Species___ES20__compute_vars_phys(self, environment)
      },
      area_leaf_above = function(height) {
        Species___ES20__area_leaf_above(self, height)
      },
      add_seed = function() {
        Species___ES20__add_seed(self)
      },
      cohort_at = function(index) {
        Species___ES20__cohort_at(self, index)
      },
      area_leafs_error = function(scal=1) {
        Species___ES20__area_leafs_error(self, scal)
      }),
    active=list(
      size = function(value) {
        if (missing(value)) {
          Species___ES20__size__get(self)
        } else {
          stop("Species<ES20>$size is read-only")
        }
      },
      seed = function(value) {
        if (missing(value)) {
          Species___ES20__seed__get(self)
        } else {
          stop("Species<ES20>$seed is read-only")
        }
      },
      height_max = function(value) {
        if (missing(value)) {
          Species___ES20__height_max__get(self)
        } else {
          stop("Species<ES20>$height_max is read-only")
        }
      },
      heights = function(value) {
        if (missing(value)) {
          Species___ES20__heights__get(self)
        } else {
          Species___ES20__heights__set(self, value)
        }
      },
      log_densities = function(value) {
        if (missing(value)) {
          Species___ES20__log_densities__get(self)
        } else {
          stop("Species<ES20>$log_densities is read-only")
        }
      },
      cohorts = function(value) {
        if (missing(value)) {
          Species___ES20__cohorts__get(self)
        } else {
          stop("Species<ES20>$cohorts is read-only")
        }
      },
      seeds = function(value) {
        if (missing(value)) {
          Species___ES20__seeds__get(self)
        } else {
          stop("Species<ES20>$seeds is read-only")
        }
      },
      area_leafs = function(value) {
        if (missing(value)) {
          Species___ES20__area_leafs__get(self)
        } else {
          stop("Species<ES20>$area_leafs is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
          Species___ES20__ode_size__get(self)
        } else {
          stop("Species<ES20>$ode_size is read-only")
        }
      },
      ode_state = function(value) {
        if (missing(value)) {
          Species___ES20__ode_state__get(self)
        } else {
          Species___ES20__ode_state__set(self, value)
        }
      },
      ode_rates = function(value) {
        if (missing(value)) {
          Species___ES20__ode_rates__get(self)
        } else {
          stop("Species<ES20>$ode_rates is read-only")
        }
      }))

Patch <- function(T) {
  type <- c(T)
  valid <- list("Patch<FF16>"="FF16", "Patch<FF16r>"="FF16r", "Patch<ES20>"="ES20")
  constructors <- list("Patch<FF16>"=`Patch<FF16>`, "Patch<FF16r>"=`Patch<FF16r>`, "Patch<ES20>"=`Patch<ES20>`)
  constructors[[check_type(type, valid)]]
}
...
`Patch<ES20>` <- function(parameters) {
  Patch___ES20__ctor(parameters)
}
.R6_Patch___ES20 <-
  R6::R6Class(
    "Patch<ES20>",
    ...
    public=list(
      ...
      area_leaf_above = function(height) {
        Patch___ES20__area_leaf_above(self, height)
      },
      canopy_openness = function(height) {
        Patch___ES20__canopy_openness(self, height)
      },
      add_seed = function(species_index) {
        Patch___ES20__add_seed(self, species_index)
      },
      compute_light_environment = function() {
        Patch___ES20__compute_light_environment(self)
      },
      compute_vars_phys = function() {
        Patch___ES20__compute_vars_phys(self)
      },
      reset = function() {
        Patch___ES20__reset(self)
      },
      set_ode_state = function(values, time) {
        Patch___ES20__set_ode_state(self, values, time)
      },
      derivs = function(y, time) {
        Patch___ES20__derivs(self, y, time)
      },
      set_state = function(time, state, n, light_env) {
        Patch___ES20__set_state(self, time, state, n, light_env)
      }),
    active=list(
      time = function(value) {
        if (missing(value)) {
          Patch___ES20__time__get(self)
        } else {
          stop("Patch<ES20>$time is read-only")
        }
      },
      size = function(value) {
        if (missing(value)) {
          Patch___ES20__size__get(self)
        } else {
          stop("Patch<ES20>$size is read-only")
        }
      },
      height_max = function(value) {
        if (missing(value)) {
          Patch___ES20__height_max__get(self)
        } else {
          stop("Patch<ES20>$height_max is read-only")
        }
      },
      parameters = function(value) {
        if (missing(value)) {
          Patch___ES20__parameters__get(self)
        } else {
          stop("Patch<ES20>$parameters is read-only")
        }
      },
      environment = function(value) {
        if (missing(value)) {
          Patch___ES20__environment__get(self)
        } else {
          stop("Patch<ES20>$environment is read-only")
        }
      },
      species = function(value) {
        if (missing(value)) {
          Patch___ES20__species__get(self)
        } else {
          stop("Patch<ES20>$species is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
          Patch___ES20__ode_size__get(self)
        } else {
          stop("Patch<ES20>$ode_size is read-only")
        }
      },
      ode_time = function(value) {
        if (missing(value)) {
          Patch___ES20__ode_time__get(self)
        } else {
          stop("Patch<ES20>$ode_time is read-only")
        }
      },
      ode_state = function(value) {
        if (missing(value)) {
          Patch___ES20__ode_state__get(self)
        } else {
          stop("Patch<ES20>$ode_state is read-only")
        }
      },
      ode_rates = function(value) {
        if (missing(value)) {
          Patch___ES20__ode_rates__get(self)
        } else {
          stop("Patch<ES20>$ode_rates is read-only")
        }
      }))

SCM <- function(T) {
  type <- c(T)
  valid <- list("SCM<FF16>"="FF16", "SCM<FF16r>"="FF16r", "SCM<ES20>"="ES20")
  constructors <- list("SCM<FF16>"=`SCM<FF16>`, "SCM<FF16r>"=`SCM<FF16r>`, "SCM<ES20>"=`SCM<ES20>`)
  constructors[[check_type(type, valid)]]
}
...
`SCM<ES20>` <- function(parameters) {
  SCM___ES20__ctor(parameters)
}
.R6_SCM___ES20 <-
  R6::R6Class(
    "SCM<ES20>",
    ...
    public=list(
      ...
      run = function() {
        SCM___ES20__run(self)
      },
      run_next = function() {
        SCM___ES20__run_next(self)
      },
      reset = function() {
        SCM___ES20__reset(self)
      },
      seed_rain = function(species_index) {
        SCM___ES20__seed_rain(self, species_index)
      },
      seed_rain_cohort = function(species_index) {
        SCM___ES20__seed_rain_cohort(self, species_index)
      },
      area_leaf_error = function(species_index) {
        SCM___ES20__area_leaf_error(self, species_index)
      },
      set_cohort_schedule_times = function(times) {
        SCM___ES20__set_cohort_schedule_times(self, times)
      }),
    active=list(
      complete = function(value) {
        if (missing(value)) {
          SCM___ES20__complete__get(self)
        } else {
          stop("SCM<ES20>$complete is read-only")
        }
      },
      time = function(value) {
        if (missing(value)) {
          SCM___ES20__time__get(self)
        } else {
          stop("SCM<ES20>$time is read-only")
        }
      },
      seed_rains = function(value) {
        if (missing(value)) {
          SCM___ES20__seed_rains__get(self)
        } else {
          stop("SCM<ES20>$seed_rains is read-only")
        }
      },
      parameters = function(value) {
        if (missing(value)) {
          SCM___ES20__parameters__get(self)
        } else {
          stop("SCM<ES20>$parameters is read-only")
        }
      },
      patch = function(value) {
        if (missing(value)) {
          SCM___ES20__patch__get(self)
        } else {
          stop("SCM<ES20>$patch is read-only")
        }
      },
      cohort_schedule = function(value) {
        if (missing(value)) {
          SCM___ES20__cohort_schedule__get(self)
        } else {
          SCM___ES20__cohort_schedule__set(self, value)
        }
      },
      ode_times = function(value) {
        if (missing(value)) {
          SCM___ES20__ode_times__get(self)
        } else {
          stop("SCM<ES20>$ode_times is read-only")
        }
      },
      state = function(value) {
        if (missing(value)) {
          SCM___ES20__state__get(self)
        } else {
          stop("SCM<ES20>$state is read-only")
        }
      },
      use_ode_times = function(value) {
        if (missing(value)) {
          SCM___ES20__use_ode_times__get(self)
        } else {
          SCM___ES20__use_ode_times__set(self, value)
        }
      },
      seed_rain_error = function(value) {
        if (missing(value)) {
          SCM___ES20__seed_rain_error__get(self)
        } else {
          stop("SCM<ES20>$seed_rain_error is read-only")
        }
      }))

StochasticSpecies <- function(T) {
  type <- c(T)
  valid <- list("StochasticSpecies<FF16>"="FF16", "StochasticSpecies<FF16r>"="FF16r", "StochasticSpecies<ES20>"="ES20")
  constructors <- list("StochasticSpecies<FF16>"=`StochasticSpecies<FF16>`, "StochasticSpecies<FF16r>"=`StochasticSpecies<FF16r>`, "StochasticSpecies<ES20>"=`StochasticSpecies<ES20>`)
  constructors[[check_type(type, valid)]]
}
...
`StochasticSpecies<ES20>` <- function(strategy) {
  StochasticSpecies___ES20__ctor(strategy)
}
.R6_StochasticSpecies___ES20 <-
  R6::R6Class(
    "StochasticSpecies<ES20>",
    inherit=.R6_StochasticSpecies,
    portable=TRUE,
    public=list(
      .ptr=NULL,
      ...
      clear = function() {
        StochasticSpecies___ES20__clear(self)
      },
      compute_vars_phys = function(environment) {
        StochasticSpecies___ES20__compute_vars_phys(self, environment)
      },
      area_leaf_above = function(height) {
        StochasticSpecies___ES20__area_leaf_above(self, height)
      },
      add_seed = function() {
        StochasticSpecies___ES20__add_seed(self)
      },
      plant_at = function(index) {
        StochasticSpecies___ES20__plant_at(self, index)
      },
      deaths = function() {
        StochasticSpecies___ES20__deaths(self)
      },
      germination_probability = function(environment) {
        StochasticSpecies___ES20__germination_probability(self, environment)
      }),
    active=list(
      size = function(value) {
        if (missing(value)) {
          StochasticSpecies___ES20__size__get(self)
        } else {
          stop("StochasticSpecies<ES20>$size is read-only")
        }
      },
      size_plants = function(value) {
        if (missing(value)) {
          StochasticSpecies___ES20__size_plants__get(self)
        } else {
          stop("StochasticSpecies<ES20>$size_plants is read-only")
        }
      },
      seed = function(value) {
        if (missing(value)) {
          StochasticSpecies___ES20__seed__get(self)
        } else {
          stop("StochasticSpecies<ES20>$seed is read-only")
        }
      },
      height_max = function(value) {
        if (missing(value)) {
          StochasticSpecies___ES20__height_max__get(self)
        } else {
          stop("StochasticSpecies<ES20>$height_max is read-only")
        }
      },
      heights = function(value) {
        if (missing(value)) {
          StochasticSpecies___ES20__heights__get(self)
        } else {
          StochasticSpecies___ES20__heights__set(self, value)
        }
      },
      plants = function(value) {
        if (missing(value)) {
          StochasticSpecies___ES20__plants__get(self)
        } else {
          stop("StochasticSpecies<ES20>$plants is read-only")
        }
      },
      is_alive = function(value) {
        if (missing(value)) {
          StochasticSpecies___ES20__is_alive__get(self)
        } else {
          stop("StochasticSpecies<ES20>$is_alive is read-only")
        }
      },
      seeds = function(value) {
        if (missing(value)) {
          StochasticSpecies___ES20__seeds__get(self)
        } else {
          stop("StochasticSpecies<ES20>$seeds is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
          StochasticSpecies___ES20__ode_size__get(self)
        } else {
          stop("StochasticSpecies<ES20>$ode_size is read-only")
        }
      },
      ode_state = function(value) {
        if (missing(value)) {
          StochasticSpecies___ES20__ode_state__get(self)
        } else {
          StochasticSpecies___ES20__ode_state__set(self, value)
        }
      },
      ode_rates = function(value) {
        if (missing(value)) {
          StochasticSpecies___ES20__ode_rates__get(self)
        } else {
          stop("StochasticSpecies<ES20>$ode_rates is read-only")
        }
      }))

StochasticPatch <- function(T) {
  type <- c(T)
  valid <- list("StochasticPatch<FF16>"="FF16", "StochasticPatch<FF16r>"="FF16r", "StochasticPatch<ES20>"="ES20")
  constructors <- list("StochasticPatch<FF16>"=`StochasticPatch<FF16>`, "StochasticPatch<FF16r>"=`StochasticPatch<FF16r>`, "StochasticPatch<ES20>"=`StochasticPatch<ES20>`)
  constructors[[check_type(type, valid)]]
}
...
`StochasticPatch<ES20>` <- function(parameters) {
  StochasticPatch___ES20__ctor(parameters)
}
.R6_StochasticPatch___ES20 <-
  R6::R6Class(
    "StochasticPatch<ES20>",
    inherit=.R6_StochasticPatch,
    portable=TRUE,
    public=list(
      .ptr=NULL,
      ...
      area_leaf_above = function(height) {
        StochasticPatch___ES20__area_leaf_above(self, height)
      },
      canopy_openness = function(height) {
        StochasticPatch___ES20__canopy_openness(self, height)
      },
      add_seed = function(species_index) {
        StochasticPatch___ES20__add_seed(self, species_index)
      },
      add_seedling = function(species_index) {
        StochasticPatch___ES20__add_seedling(self, species_index)
      },
      compute_light_environment = function() {
        StochasticPatch___ES20__compute_light_environment(self)
      },
      compute_vars_phys = function() {
        StochasticPatch___ES20__compute_vars_phys(self)
      },
      reset = function() {
        StochasticPatch___ES20__reset(self)
      },
      set_ode_state = function(values, time) {
        StochasticPatch___ES20__set_ode_state(self, values, time)
      },
      derivs = function(y, time) {
        StochasticPatch___ES20__derivs(self, y, time)
      },
      set_state = function(time, state, n) {
        StochasticPatch___ES20__set_state(self, time, state, n)
      },
      deaths = function() {
        StochasticPatch___ES20__deaths(self)
      }),
    active=list(
      time = function(value) {
        if (missing(value)) {
          StochasticPatch___ES20__time__get(self)
        } else {
          stop("StochasticPatch<ES20>$time is read-only")
        }
      },
      size = function(value) {
        if (missing(value)) {
          StochasticPatch___ES20__size__get(self)
        } else {
          stop("StochasticPatch<ES20>$size is read-only")
        }
      },
      height_max = function(value) {
        if (missing(value)) {
          StochasticPatch___ES20__height_max__get(self)
        } else {
          stop("StochasticPatch<ES20>$height_max is read-only")
        }
      },
      parameters = function(value) {
        if (missing(value)) {
          StochasticPatch___ES20__parameters__get(self)
        } else {
          stop("StochasticPatch<ES20>$parameters is read-only")
        }
      },
      environment = function(value) {
        if (missing(value)) {
          StochasticPatch___ES20__environment__get(self)
        } else {
          stop("StochasticPatch<ES20>$environment is read-only")
        }
      },
      species = function(value) {
        if (missing(value)) {
          StochasticPatch___ES20__species__get(self)
        } else {
          stop("StochasticPatch<ES20>$species is read-only")
        }
      },
      ode_size = function(value) {
        if (missing(value)) {
          StochasticPatch___ES20__ode_size__get(self)
        } else {
          stop("StochasticPatch<ES20>$ode_size is read-only")
        }
      },
      ode_time = function(value) {
        if (missing(value)) {
          StochasticPatch___ES20__ode_time__get(self)
        } else {
          stop("StochasticPatch<ES20>$ode_time is read-only")
        }
      },
      ode_state = function(value) {
        if (missing(value)) {
          StochasticPatch___ES20__ode_state__get(self)
        } else {
          stop("StochasticPatch<ES20>$ode_state is read-only")
        }
      },
      ode_rates = function(value) {
        if (missing(value)) {
          StochasticPatch___ES20__ode_rates__get(self)
        } else {
          stop("StochasticPatch<ES20>$ode_rates is read-only")
        }
      }))

StochasticPatchRunner <- function(T) {
  type <- c(T)
  valid <- list("StochasticPatchRunner<FF16>"="FF16", "StochasticPatchRunner<FF16r>"="FF16r", "StochasticPatchRunner<ES20>"="ES20")
  constructors <- list("StochasticPatchRunner<FF16>"=`StochasticPatchRunner<FF16>`, "StochasticPatchRunner<FF16r>"=`StochasticPatchRunner<FF16r>`, "StochasticPatchRunner<ES20>"=`StochasticPatchRunner<ES20>`)
  constructors[[check_type(type, valid)]]
}
...
`StochasticPatchRunner<ES20>` <- function(parameters) {
  StochasticPatchRunner___ES20__ctor(parameters)
}
.R6_StochasticPatchRunner___ES20 <-
  R6::R6Class(
    "StochasticPatchRunner<ES20>",
    inherit=.R6_StochasticPatchRunner,
    portable=TRUE,
    public=list(
      .ptr=NULL,
      ...
      run = function() {
        StochasticPatchRunner___ES20__run(self)
      },
      run_next = function() {
        StochasticPatchRunner___ES20__run_next(self)
      },
      reset = function() {
        StochasticPatchRunner___ES20__reset(self)
      },
      set_schedule_times = function(times) {
        StochasticPatchRunner___ES20__set_schedule_times(self, times)
      }),
    active=list(
      complete = function(value) {
        if (missing(value)) {
          StochasticPatchRunner___ES20__complete__get(self)
        } else {
          stop("StochasticPatchRunner<ES20>$complete is read-only")
        }
      },
      time = function(value) {
        if (missing(value)) {
          StochasticPatchRunner___ES20__time__get(self)
        } else {
          stop("StochasticPatchRunner<ES20>$time is read-only")
        }
      },
      parameters = function(value) {
        if (missing(value)) {
          StochasticPatchRunner___ES20__parameters__get(self)
        } else {
          stop("StochasticPatchRunner<ES20>$parameters is read-only")
        }
      },
      patch = function(value) {
        if (missing(value)) {
          StochasticPatchRunner___ES20__patch__get(self)
        } else {
          stop("StochasticPatchRunner<ES20>$patch is read-only")
        }
      },
      schedule = function(value) {
        if (missing(value)) {
          StochasticPatchRunner___ES20__schedule__get(self)
        } else {
          StochasticPatchRunner___ES20__schedule__set(self, value)
        }
      },
      state = function(value) {
        if (missing(value)) {
          StochasticPatchRunner___ES20__state__get(self)
        } else {
          stop("StochasticPatchRunner<ES20>$state is read-only")
        }
      }))
...
cohort_schedule_max_time_default <- function(p) {
  ...
  switch(cl,
         ...
         "Parameters<ES20>"=`cohort_schedule_max_time_default__Parameters___ES20`,
...
cohort_schedule_default <- function(p) {
  ...
  switch(cl,
         ...
         "Parameters<ES20>"=`cohort_schedule_default__Parameters___ES20`,
         stop("Unknown type: ", cl))(p)
}
...
make_cohort_schedule <- function(p) {
  ...
  switch(cl,
         ...
         "Parameters<ES20>"=`make_cohort_schedule__Parameters___ES20`,
         stop("Unknown type: ", cl))(p)
}
