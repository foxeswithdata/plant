...
cohort_schedule_max_time_default <- function(p) {
  ...
  switch(cl,
         ...
         "Parameters<ES20,ES20_Env>"=`cohort_schedule_max_time_default__Parameters___ES20__ES20_Env`,
...
cohort_schedule_default <- function(p) {
  ...
  switch(cl,
         ...
         "Parameters<ES20,ES20_Env>"=`cohort_schedule_default__Parameters___ES20__ES20_Env`,
...
make_cohort_schedule <- function(p) {
  ...
  switch(cl,
         ...
         "Parameters<ES20,ES20_Env>"=`make_cohort_schedule__Parameters___ES20__ES20_Env`,
